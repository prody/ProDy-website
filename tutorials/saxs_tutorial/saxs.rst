...
We will call :meth:`calcSaxsPerModel` to compute SAXS profile of our initial
...
We can write this SAXS profile to a file using :meth:`writeSaxsProfile`.
...
can use :meth:`interpolateMode` function. Return value of this function
...
.. ipython:: python
   ...
   chi_list, frames_list=interpolateMode(calphas, anm[0], Q_exp, I_q_exp,\
	     sigma_q, maxChi)
