...
with resolutions ranging from 2 to 100 Å. Fitting all-atom 
...
(using a published algorithm [TM94]_), which can be further used 
...
.. _EMDDatabank: https://www.ebi.ac.uk/pdbe/emdb/
